...
def main():
    ...
    activities = ["Home", "Recognize My Facial Expressions","Webcam Face Detection", "See Model Performance", "About"]
    ...
    if choice == "Webcam Face Detection":
        ...
        webrtc_streamer(key="example", video_transformer_factory=VideoCamera)
